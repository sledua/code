...
function f4(){
	let year = 2022 - +document.querySelector('.i-4').value;
	if (year >= 18) {
...
function f8(){
	...
	switch (i) {
		...
		case 3: 
			...
			break
		default:
			document.querySelector('.out-8').textContent = 'switch'
	}
}
...
function f14(){
	...
	let rate = document.querySelector('.s-143').value;
	switch (rate) {
		case '+':
...
function f15(){
	...
	let rate = document.querySelector('.s-153').value;
	switch (rate) {
		case '&&':
