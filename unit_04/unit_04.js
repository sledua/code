...
function f5() {
	...
	if (c.checked) {
		document.querySelector('div.out-5').innerHTML = c.value
	} else {
...
function f7() {
	...
	let ir = document.querySelector('div.out-71');
	let r = document.querySelector('div.out-72');
	if (i.length >= 6) {
		ir.innerHTML = i;
		r.innerHTML = 1;
	} else {
...
function f9() {
	let f = document.querySelector('.r-9');
	if (f.checked) {
		document.querySelector('div.out-9').innerHTML = f.value
	} else {
...
function f10() {
	...
	document.querySelector('.out-10').style.background = c;
}
...
function f11() {
	let r = document.querySelector('input.i-111').value
	let rr = document.querySelector('input.i-112')
	rr.value = r
}
...
function f16() {
    // для получения выбранного option просто получите select в переменную и select.value;
		document.querySelector('div.out-16').innerHTML = document.querySelector('.s-16').value;
...
function f17() {
	document.querySelector('div.out-17').innerHTML = document.querySelector('.s-17').value;
}
...
function f20() {
let r = document.querySelector('.s-201').value
let rr = document.querySelector('.s-202')
rr.value = r
}
